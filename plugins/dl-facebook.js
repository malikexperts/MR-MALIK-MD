...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  ...
  try {
    ...
    conn.sendFile(m.chat, r2es, 'error.mp4', `_*< Malik - FACEBOOK />*_\n\n`, m);
  } catch (err1) {
    try {
        ...
        try {
          ...
          try {
            ...
            for (const result of res.download) {
              const ur = result.url;
              await conn.sendFile(m.chat, ur, 'error.mp4', '_*< Malik - FACEBOOK />*_\n\n', m);
            }
          } catch (err4) {
            try {
              ...
              await conn.sendFile(m.chat, url3, 'error.mp4', '_*< Malik - FACEBOOK />*_\n\n', m);
            } catch (err5) {
              try {
...
handler.command = /^(facebook2|fb2|facebookdl2|fbdl2|facebook3|fb3|facebookdl3|fbdl3|facebook4|fb4|facebookdl4|fbdl4|facebook5|fb5|facebookdl5|fbdl5)$/i;
